...
import ModalFilterSeragam from '@/Components/modal/ModalFilterSeragam';
    ...
    return (
        <div className="flex h-screen bg-gray-100 overflow-hidden">
            ...
            <div className={`flex-1 flex flex-col ${sidebarOpen ? 'md:ml-64' : ''}`}>
                ...
                <ModalFilterSeragam openFilterModal={openFilterModal} setOpenFilterModal={setOpenFilterModal} hariIni={props.hariIni} />
            </div>
            <CustomFooter />
        </div>
    );
