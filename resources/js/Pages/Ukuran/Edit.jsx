                    ...
                    <div className="bg-white shadow-lg rounded-lg p-2 md:p-6 border border-gray-200 mb-16">
                        <div className="overflow-x-auto p-2">
                            <form onSubmit={submit}>
                                <div className="mb-4">
                                    <label for="barang_id" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Nama Kategori</label>
                                    <input type="text" onChange={(e) => setData('barang_id', e.target.value)} id="barang_id" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" value={data.barang_id} />
                                    {errors.barang_id && <p className="mt-2 text-sm text-red-600 dark:text-red-500">{errors.barang_id}</p>}
                                </div>
                                <div className="mb-4">
                                    <label for="ukuran" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Nama Kategori</label>
